...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pydrill-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12753&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pydrill-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pydrill` can be installed with:

```
conda install pydrill
```

It is possible to list all of the versions of `pydrill` available on your platform with:
